      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex w-full items-center gap-2 sm:w-auto">
            ...
            <DialogTrigger asChild>
                <Button onClick={openCreate} className="w-full shadow-sm sm:w-auto">
        ...
        <CardContent className="p-0">
          {isLoading ? (
            ...
            <div className="space-y-3 p-4 md:hidden">
                {leads.length === 0 ? (
                    <div className="rounded-xl border border-dashed border-slate-300 bg-slate-50 px-4 py-12 text-center text-slate-500">
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div className="min-w-0 flex-1">
                                    <div className="flex items-start justify-between gap-3">
                                        ...
                                        <Badge variant="outline" className={cn("font-medium shrink-0", statusConfig[lead.status]?.className)}>
                                    ...
                                    <div className="mt-3 grid gap-2 text-sm text-slate-600">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="font-medium text-slate-900">{lead.estimatedValue.toLocaleString()}</span>
                                        </div>
                                        <div className="flex items-center gap-2">
                                    ...
                                    <div className="mt-4 flex items-center gap-2">
                                        <Button variant="outline" size="sm" className="flex-1" onClick={() => navigate(`/leads/${lead.id}`)}>
                                            <Eye className="mr-2 h-4 w-4" />
                                            View
                                        </Button>
                                        <Button variant="outline" size="icon" onClick={() => openEdit(lead)} title="Edit Lead">
                                        ...
                                        <ConfirmDialog
                                            ...
                                            trigger={
                                              <Button variant="outline" size="icon" title="Delete Lead">
